package frontend;//import static frontend.Toktype;
...
public class Lexer {
	...
	public class LexerException extends CompilerException {
		...
		public LexerException (String mesg) {
			super("frontend.Lexer error at " + read + ":  " + mesg);
		}
	}
...
//		if ((t = attempt ("this", frontend.Toktype.THIS)) != null) return t;
//		if ((t = attempt ("super", frontend.Toktype.SUPER)) != null) return t;
